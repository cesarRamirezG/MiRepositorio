 ...
 * @version 1.0
 */
public class Recordsfin extends Actor
{
     ...
     */
    public Recordsfin(int width, int height)
    {    
    ...
    {
        getImage().drawImage(new GreenfootImage(text, height, color, new Color (0,0,0)), x, y);
    }
